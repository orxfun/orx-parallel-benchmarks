...
pub enum ComputeType {
    /// Very light bitwise/arithmetic operations (~few ns per item).
    /// Highly sensitive to lock contention and pull frequency in ConIterOfIter.
    Light,
...
pub enum PipelineType {
    ...
    /// Evaluates the filter condition inside iterator traversal under the lock.
    FilterMap,
